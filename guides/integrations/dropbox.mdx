---
title: 'Dropbox'
description: 'How to use Zapier Integration with Dropbox'
icon: 'dropbox'
---
...
- A Zapier account [Login](https://zapier.com/sign-up?utm_adgroup=brand_existing&gclid=CjwKCAiAjrarBhAWEiwA2qWdCGW11lcQCuGxav7Rwok_QPsNlNLmN_SPBZg-3-0tpJP_n5DdQorAsxoCPaoQAvD_BwE&utm_medium=cpc&utm_term=zapier%20account&gad_source=1&utm_content=1007808&utm_source=google&utm_campaign=gaw-gbl-nua-search-brand-remarketing).
- A Dropbox account.
- A Hansei account [Login](https://hansei.app/login).
...
For more detailed instructions or troubleshooting, please refer to the [Zapier Help Center](https://zapier.com/help/)
