---
title: 'Discord'
description: 'How to use Zapier Integration with Discord'
icon: 'discord'
---
...
### Prerequisites
- Sign in to [Zapier](https://zapier.com/sign-up?utm_adgroup=brand_existing&gclid=CjwKCAiAjrarBhAWEiwA2qWdCGW11lcQCuGxav7Rwok_QPsNlNLmN_SPBZg-3-0tpJP_n5DdQorAsxoCPaoQAvD_BwE&utm_medium=cpc&utm_term=zapier%20account&gad_source=1&utm_content=1007808&utm_source=google&utm_campaign=gaw-gbl-nua-search-brand-remarketing)
- A Discord account with administrative privileges [Login](https://hammerandchisel.zendesk.com/auth/v2/login/signin?return_to=https%3A%2F%2Fsupport.discord.com%2Fhc%2Fen-us%2Fcommunity%2Fposts%2F360056220432-Login&theme=hc&locale=en-us&brand_id=96508&auth_origin=96508%2Ctrue%2Ctrue)
- Access to [Hansei](https://hansei.app/login)
