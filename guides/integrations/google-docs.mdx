...
Using Zapier, we can seamlessly connect Google Docs with Hansei AI to automatically transfer information between the two platforms. 

In this guide, we'll walk through the simple steps to configure this integration so that new Google Docs become instantly available as knowledge in Hansei.

## Steps to Connect Google Docs with Hansei

### Step 1: Log in to Zapier
<img
  src="/images/zapier-login.png"
  alt="Zapier Login"
/>
